...
let firstNameAllCaps = runners.map( runner => runner['first_name'].toUpperCase())
...
let runnerlargeSizeShirt = runners.filter ( runner => runner.shirt_size === 'L')
console.log(runnerlargeSizeShirt)
